...
class CustomerControllerTest {
    ...
    void updateCustomer() throws Exception {
        ...
        CustomerDTO returnCustomer = new CustomerDTO();
        returnCustomer.setId(1L);
        returnCustomer.setFirstName(customer.getFirstName());
        returnCustomer.setCustomerUrl("/api/v1/customer/1");

        when(customerService.updateCustomerById(1L,customer)).thenReturn(returnCustomer);
    ...
    void patchCustomer() throws Exception {
        ...
        when(customerService.patchCustomer(1L,customer)).thenReturn(returnCustomer);
